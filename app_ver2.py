...
tab_leaderboard, tab_score_rules, tab_rules, tab_bracket = st.tabs(["Bảng xếp hạng", "Cách tính điểm", "Luật", "Phân nhánh"])

with tab_leaderboard:

    # Load data
    df = pd.read_csv("data/standing.csv").dropna(how='all')
    df_dim_team = pd.read_csv('data/dim_team.csv')
